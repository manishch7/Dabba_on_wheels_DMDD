...
VALUES (SUB_SEQ.NEXTVAL, TO_DATE('2023-12-01', 'YYYY-MM-DD'), TO_DATE('2023-12-08', 'YYYY-MM-DD'), 222001, 555001, 10);


INSERT INTO SUBSCRIPTION (sub_id, start_date, end_date, sub_type_id, c_id, no_of_meals_left)
VALUES (SUB_SEQ.NEXTVAL, TO_DATE('2023-12-01', 'YYYY-MM-DD'), TO_DATE('2023-12-29', 'YYYY-MM-DD'), 222002, 555002, 45);

INSERT INTO SUBSCRIPTION (sub_id, start_date, end_date, sub_type_id, c_id, no_of_meals_left)
VALUES (SUB_SEQ.NEXTVAL, TO_DATE('2023-12-01', 'YYYY-MM-DD'), TO_DATE('2023-12-08', 'YYYY-MM-DD'), 222001, 555003,10);

INSERT INTO SUBSCRIPTION (sub_id, start_date, end_date, sub_type_id, c_id, no_of_meals_left)
VALUES (SUB_SEQ.NEXTVAL, TO_DATE('2023-12-03', 'YYYY-MM-DD'), TO_DATE('2023-12-31', 'YYYY-MM-DD'), 222002, 555004, 45);

INSERT INTO SUBSCRIPTION (sub_id, start_date, end_date, sub_type_id, c_id, no_of_meals_left)
VALUES (SUB_SEQ.NEXTVAL, TO_DATE('2023-12-05', 'YYYY-MM-DD'), TO_DATE('2024-01-02', 'YYYY-MM-DD'), 222002, 555005, 45);
